...
Per `docs/PRD.md`'s Bolt numbering: Phase 1 (Bolts 1–10, the MVP) plus Bolt 12 (trend insights, built ahead of schedule) are done. Bolt 11 (daily digest + recurring reminders) is code-complete on `feature/bolt-11-digest-and-recurring-reminders` (not yet merged) but has never actually sent an email — see Bolt 11a, blocked on setting up a real Resend account. Bolt 13 (co-owner invites) is Phase 3, explicitly deferred. Phase 3 more broadly (14–18) is also deferred in the PRD.

...
export async function extractDocument(file: UploadedFile, currentPet: CurrentPetVetInfo): Promise<ExtractionResult> {
  ...
  return {
    ...
    vetInfoUpdate: buildVetInfoUpdate(obj.vetInfo, currentPet),
  };
}
